...
#define IMU660RA_SCL_PIN            (BSP_IO_PORT_06_PIN_01)                                       // 软件 IIC SCL 引脚 连接 IMU660RA 的 SCL 引脚
#define IMU660RA_SDA_PIN            (BSP_IO_PORT_06_PIN_03)                                       // 软件 IIC SDA 引脚 连接 IMU660RA 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define IMU660RA_CS_PIN             ( BSP_IO_PORT_06_PIN_04 )
//====================================================硬件 SPI 驱动====================================================
#endif
