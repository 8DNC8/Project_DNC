...
// Hardware Interface
#define SCC8660_SOFTIIC_SCL     BSP_IO_PORT_07_PIN_06
#define SCC8660_SOFTIIC_SDA     BSP_IO_PORT_07_PIN_07
...
void g_ceu0_user_callback (capture_callback_args_t * p_args)
{
    ...
    /* 注意：这里不再自动 captureStart 重启采集！
     * 改为主循环在拷贝完一帧后再手动 captureStart 武装下一帧，
     * 避免 CEU 边往 scc8660_image 里写、主循环边读导致画面撕裂/花屏。 */
}
